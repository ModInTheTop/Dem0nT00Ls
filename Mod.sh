...
echo -e "\033[47;31;5m Está instalando actualizaciones y solicitudes...\033[0m"
sleep 5
pkg install git -y
...
echo -e "\033[47;3;35m Esta instalación te llevará mucho tiempo\033[0m"
echo -e "\033[47;3;35m [ Para detenerlo presióna Ctrl+C ]\033[0m"
sleep 4
php index.php update-nodes
php index.php refine-nodes
echo "-------------------------"
read -p "Dar una dirección de correo electrónico para bombardear: " mail
echo "-------------------------"
...
echo -e "\033[47;3;35m Vaya a su navegador / cambie el representante (sock proxy) en 127.0.0.1:9050\033[0m"
sleep 8
python3 install.py
aut
